...
function TableAuthor({setAuthor ,author, handleEdit, search, setPage, page }) {
    ...
    const onConfirm = async () => {
        await deleteDocument("Authors", author.id);
        showNotification("authors deleted successfully!", "error");
        setOpen(false);
    ...
    const dataFilter = authors.filter(e =>

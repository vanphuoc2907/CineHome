...
function TablePackage({ setPackage, Package, handleEdit, search, setPage, page }) {
  ...
  const onConfirm = async () => {
    await deleteDocument("Packages", Package.id);
    showNotification("Packages deleted successfully!", "error");
    setOpen(false);
  };
  ...
  // Sửa lỗi toLowerCase() an toàn
  const dataFilter = (Packages || []).filter(e =>

...
import {
    Table, Button, TableBody, TableContainer,
    TableHead, TableRow, Paper, TableCell,
    tableCellClasses, TablePagination
} from '@mui/material';
import { ContextUserpages } from "../../../context/UserpageProvider";
...
function TableUserpage({ setUserpage, userpage, handleEdit, search, setPage, page }) {
    ...
    const onConfirm = async () => {
        await deleteDocument("Userpages", userpage.id);
        showNotification("Userpages deleted successfully!", "error");
        setOpen(false);
    };
    ...
    const dataFilter = accounts.filter(e =>

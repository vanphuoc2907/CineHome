...
function TableCategory({ setCategory, category, handleEdit, search, setPage, page }) {
    ...
    const onConfirm = async () => {
        ...
        showNotification("Categories deleted successfully!", "error");
        setOpen(false);
    };
    ...
    const dataFilter = categories.filter(e => 
